...
function FilmTubeTVGenersPage({
  ...
  async function GetGenersMovies() {
    const response = await fetch( `https://api.themoviedb.org/3/genre/tv/list?api_key=6a63466bd16b2f9626f41e66cf666555&language=en-US`);
        ...
        <div className=" grid grid-cols-2 gap-5 flex-wrap justify-center my-5">
          ...
          {genres && genres && genres.map((target) => (
              ...
              color="error"
                ...
                style={{ color: "white",background:"#414141",fontSize:"14px" }}
...
export default FilmTubeTVGenersPage;
